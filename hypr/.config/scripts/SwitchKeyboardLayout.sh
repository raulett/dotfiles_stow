...
icon_folder="$HOME/.config/resources/icons"
ru_icon="$icon_folder/icons8-ru-96.png"
us_icon="$icon_folder/icons8-us-96.png"
...
if [[ "$new_layout" == "ru" ]]; then
  current_icon="$ru_icon"
elif [[ "$new_layout" == "usus" ]]; then
  current_icon="$us_icon"
fi
...
if ! change_layout; then
    ...
    notify-send -u low -i "$current_icon" "change layout" " kb_layout: $new_layout"
